...
#define SIGRD 5
  ...
  Serial.println(F("    Micro Ã‚Âµ Ã‚Âµ Ã‚Âµ Ã‚Âµ Ã‚Âµ Ã‚Âµ Ã‚Âµ Ã‚Âµ Ã‚Âµ Ã‚Âµ"));
  Serial.println(F("    Euro  Ã¢?Â¬ Ã¢?Â¬ Ã¢?Â¬ Ã¢?Â¬ Ã¢?Â¬ Ã¢?Â¬ Ã¢?Â¬ Ã¢?Â¬ Ã¢?Â¬ Ã¢?Â¬"));
  Serial.println(F("    (c)   Ã‚Â© Ã‚Â© Ã‚Â© Ã‚Â© Ã‚Â© Ã‚Â© Ã‚Â© Ã‚Â© Ã‚Â© Ã‚Â©"));
